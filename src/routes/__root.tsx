...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Rahul Kumar's Personal Portfolio" },
      { name: "author", content: "Rahul Kumar" },
      { property: "og:title", content: "Rahul Kumar | Portfolio" },
      { property: "og:description", content: "Rahul Kumar's Personal Portfolio" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@rahulkumar" },
    ],
    links: [
